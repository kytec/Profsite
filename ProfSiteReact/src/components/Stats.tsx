...
const products = [
  ...
  { 
    ...
    icon: '🛢️',
    shortDesc: 'High-performance lubricants for engines and machinery',
    fullDesc: 'Our range of lubricants and greases ensures smooth operation and extended lifespan of engines and machinery. Designed for automotive, industrial, and marine applications, they meet global performance and safety standards.'
  },
];
...
const Stats = () => {
  ...
  return (
    <section className="stats reveal-on-scroll" id="products" ref={revealRef}>
          ...
          <div className="products-tabs">
            {products.map((product, idx) => (
              <div 
                ...
                key={idx}
                role="tabpanel"
                aria-expanded={expandedProduct === idx}
                tabIndex={0}
              >
                ...
                <button 
                  ...
                  aria-expanded={expandedProduct === idx}
                  aria-controls={`product-details-${idx}`}
                >
